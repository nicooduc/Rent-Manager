                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" id="car" name="car">
                                            <option value="${reservation.vehicle.id}" selected disabled hidden>${reservation.vehicle.constructeur} ${reservation.vehicle.modele}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control" id="client" name="client">
                                            <option value="${reservation.client.id}" selected disabled hidden>${reservation.client.nom} ${reservation.client.prenom}</option>
