                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="constructeur" name="constructeur"
                                                    minlength="1" value=${vehicle.constructeur} placeholder=${vehicle.constructeur}>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" id="modele" name="modele" minlength="1"
                                                    value=${vehicle.modele} placeholder=${vehicle.modele}>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" id="nb_places" name="nb_places" min="2"
                                                    max="9" value=${vehicle.nb_places} placeholder=${vehicle.nb_places}>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.box-body -->
